...
function editCategory(int $id, string $category) {
    ...
    $query = "UPDATE kategoriler SET KategoriAdi='$category' WHERE id=$id";
    $sonuc = mysqli_query($baglanti,$query);
    mysqli_close($baglanti);
    return $sonuc;
}
...
function editCourse(int $id, string $baslik,string $altBaslik,string $aciklama,string $resim,int $onay,int $anasayfa) {
    ...
    $query = "UPDATE kurslar SET baslik='$baslik',altBaslik='$altBaslik',aciklama='$aciklama',resim='$resim',
    onay=$onay,anasayfa=$anasayfa WHERE id=$id";
    $sonuc = mysqli_query($baglanti,$query);
    mysqli_close($baglanti);
    return $sonuc;
}
...
function createCategory(string $kategori) {
    ...
    $query = "INSERT INTO kategoriler(KategoriAdi) VALUES (?)";
